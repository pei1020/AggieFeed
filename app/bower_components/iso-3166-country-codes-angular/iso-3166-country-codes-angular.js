...
angular.module('iso-3166-country-codes', [])
  .service('ISO3166', function() {
    ...
    function getCountryCode (callback) {
      ...
      var place, country, encoded;

      //check if there is/are comma(s)
      //decide how to split it, trim and get country code
      if (str.indexOf(',') > -1) {
        place = str.split(',');
        if(place.length == 3)
          country = place[2].trim();
        else {
          country = place[1].trim();
        }
        encoded = holder.countryToCode[country];
      }
      else {
        //if can't split the country
        encoded = "";
      }
      callback(encoded);
    };
      this.getCode =  getCountryCode;
})
